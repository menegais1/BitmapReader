...
Color *Bitmap::getPixelColorAtPosition(int l, int c) const
{
...
Int2 Bitmap::getPixelPositionOnScreen(int l, int c) const
{
...
int *Bitmap::getHistogramForChannel(Channel c) const
{
